...
[test-image]: https://github.com/stdlib-js/napi-argv-uint32/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/napi-argv-uint32/actions/workflows/test.yml?query=branch:v0.2.2
